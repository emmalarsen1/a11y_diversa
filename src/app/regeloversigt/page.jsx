...
function page() {
  return (
    <>
      <section class="mx-8 flex justify-center flex-col h-lvh">
        <h1 class="text-5xl m-2.5 mb-8">A11y-regel oversigt</h1>
        <article className="flex flex-col">
          {reglerData.map((data) => (
            <div class="flex justify-between box-border border-2 bg-turquoise-00 border-transparent border-b-neutral-950 p-4" key={data.id}>
