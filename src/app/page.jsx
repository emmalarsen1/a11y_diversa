...
export default function Home() {
  return (
    <>
      <div class="flex flex-col justify-center items-center h-lvh">
        <h1 class="text-5xl text-center m-2.5">A11y Check</h1>
        ...
        <form class="grid gap-7" action="/results">
          ...
          <button class=" mx-14 bg-[#FF7733] text-center text-white hover:text-gray-50 p-2 p-l-2.5 rounded-full hover:bg-[#FE6013] active:bg-[#DB5E1F]">CHECK URL</button>
        </form>
      </div>
    </>
  );
